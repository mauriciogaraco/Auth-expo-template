...
export default function TextInputControllerTransparent(props: TextInputControllerProps) {
  const {
          ...
          <>
            <TextInput
              ...
              outlineStyle={{
                ...
                borderWidth:0,
                borderBottomWidth:2,
                borderBottomColor:palette.icons,
              ...
              contentStyle={{ fontWeight: "600", fontSize: 24 , borderRadius:0}}
              autoCapitalize="none"
              style={{
            ...
            <HelperText
              ...
              style={{ color: palette.red, height: error ? "auto" : 10, textAlign:'center' }}
            >
              {error?.message}
            </HelperText>
          </>
