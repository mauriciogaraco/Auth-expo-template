...
export default function TextInputControllerHolderName(props: TextInputControllerProps) {
  const {
        ...
        render={({
          ...
          <>
            <TextInput
              ref={ref}
              value={value}
              onChangeText={(value) => onChange(value.replace(/[^a-zA-Z ]/g, ''))}
              onBlur={onBlur}
              outlineStyle={{
                borderRadius: 10,
              ...
              contentStyle={{ fontWeight: "600", fontSize: 15 , borderRadius:0}}
              autoCapitalize="none"
              style={{
